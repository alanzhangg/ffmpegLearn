...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=darwin --arch=armv7 --cc='xcrun -sdk iphoneos clang' --as='gas-preprocessor.pl -- xcrun -sdk iphoneos clang' --enable-cross-compile --disable-debug --disable-programs --disable-doc --enable-pic --enable-gpl --enable-libx264 --enable-libfdk-aac --enable-nonfree --extra-cflags='-arch armv7 -mios-version-min=9.0 -fembed-bitcode -I/Users/zhangalan/Desktop/ffmpegLearn/fat-x264/include -I/Users/zhangalan/Desktop/ffmpegLearn/fat-faac/include' --extra-ldflags='-arch armv7 -mios-version-min=9.0 -fembed-bitcode -L/Users/zhangalan/Desktop/ffmpegLearn/fat-x264/lib -L/Users/zhangalan/Desktop/ffmpegLearn/fat-faac/lib' --prefix=/Users/zhangalan/Desktop/ffmpegLearn/thin/armv7
prefix=/Users/zhangalan/Desktop/ffmpegLearn/thin/armv7
...
CC_IDENT=Apple clang version 11.0.0 (clang-1100.0.32.5)
ARCH=arm
INTRINSICS=neon
EXTERN_PREFIX=_
CC=xcrun -sdk iphoneos clang
CXX=g++
AS=gas-preprocessor.pl -- xcrun -sdk iphoneos clang
OBJCC=xcrun -sdk iphoneos clang
LD=xcrun -sdk iphoneos clang
DEPCC=xcrun -sdk iphoneos clang
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=gas-preprocessor.pl -- xcrun -sdk iphoneos clang
DEPASFLAGS= $(CPPFLAGS)
X86ASM=nasm
DEPX86ASM=nasm
...
CFLAGS=  -arch armv7 -mios-version-min=9.0 -fembed-bitcode -I/Users/zhangalan/Desktop/ffmpegLearn/fat-x264/include -I/Users/zhangalan/Desktop/ffmpegLearn/fat-faac/include -march=armv7-a -std=c11 -Werror=partial-availability -fomit-frame-pointer -fPIC -mthumb -pthread  -I/usr/local/Cellar/x264/r2917/include -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-char-subscripts -O3 -fno-math-errno -fno-signed-zeros -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCFLAGS=  
ASFLAGS=  -arch armv7 -mios-version-min=9.0 -fembed-bitcode -I/Users/zhangalan/Desktop/ffmpegLearn/fat-x264/include -I/Users/zhangalan/Desktop/ffmpegLearn/fat-faac/include -march=armv7-a -fPIC -Qunused-arguments
NVCCFLAGS=--cuda-gpu-arch=sm_30 -O2 -m32 -S -nocudalib -nocudainc --cuda-device-only -include src/compat/cuda/cuda_runtime.h
AS_C=-c
AS_O=-o $@
OBJCC_C=-c
OBJCC_E=-E -o $@
...
DLLTOOL=
WINDRES=windres
DEPWINDRES=xcrun -sdk iphoneos clang
DOXYGEN=doxygen
LDFLAGS= -arch armv7 -mios-version-min=9.0 -fembed-bitcode -L/Users/zhangalan/Desktop/ffmpegLearn/fat-x264/lib -L/Users/zhangalan/Desktop/ffmpegLearn/fat-faac/lib  -march=armv7-a -Wl,-dynamic,-search_paths_first -Qunused-arguments
LDEXEFLAGS=
LDSOFLAGS=
...
CFLAGS-ffplay=-I/usr/local/include/SDL2 -D_THREAD_SAFE
...
avutil_FFLIBS=
EXTRALIBS-avdevice=-framework Foundation -lm -framework AVFoundation -framework CoreVideo -framework CoreMedia -pthread
EXTRALIBS-avfilter=-pthread -lm
EXTRALIBS-swscale=-lm
EXTRALIBS-postproc=-lm
EXTRALIBS-avformat=-lm -lbz2 -lz -Wl,-framework,CoreFoundation -Wl,-framework,Security
EXTRALIBS-avcodec=-liconv -lm -lz -framework AudioToolbox -lfdk-aac -L/usr/local/Cellar/x264/r2917/lib -lx264 -pthread -framework VideoToolbox -framework CoreFoundation -framework CoreMedia -framework CoreVideo
EXTRALIBS-swresample=-lm
EXTRALIBS-avresample=-lm
EXTRALIBS-avutil=-pthread -lm -framework VideoToolbox -framework CoreFoundation -framework CoreMedia -framework CoreVideo
EXTRALIBS-ffplay=
EXTRALIBS-ffprobe=
EXTRALIBS-ffmpeg=
