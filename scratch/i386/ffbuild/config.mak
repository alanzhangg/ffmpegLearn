...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=darwin --arch=i386 --cc='xcrun -sdk iphonesimulator clang' --as='gas-preprocessor.pl -- xcrun -sdk iphonesimulator clang' --enable-cross-compile --disable-debug --disable-programs --disable-doc --enable-pic --enable-gpl --enable-libx264 --enable-libfdk-aac --enable-nonfree --extra-cflags='-arch i386 -mios-simulator-version-min=9.0 -I/Users/zhangalan/Desktop/ffmpegLearn/fat-x264/include -I/Users/zhangalan/Desktop/ffmpegLearn/fat-faac/include' --extra-ldflags='-arch i386 -mios-simulator-version-min=9.0 -L/Users/zhangalan/Desktop/ffmpegLearn/fat-x264/lib -L/Users/zhangalan/Desktop/ffmpegLearn/fat-faac/lib' --prefix=/Users/zhangalan/Desktop/ffmpegLearn/thin/i386
prefix=/Users/zhangalan/Desktop/ffmpegLearn/thin/i386
...
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=gas-preprocessor.pl -- xcrun -sdk iphonesimulator clang
DEPASFLAGS= $(CPPFLAGS)
X86ASM=yasm
DEPX86ASM=yasm
...
DOXYGEN=doxygen
LDFLAGS= -arch i386 -mios-simulator-version-min=9.0 -L/Users/zhangalan/Desktop/ffmpegLearn/fat-x264/lib -L/Users/zhangalan/Desktop/ffmpegLearn/fat-faac/lib  -Wl,-dynamic,-search_paths_first -Qunused-arguments
LDEXEFLAGS=
LDSOFLAGS=
SHFLAGS=-dynamiclib -Wl,-single_module -Wl,-install_name,$(INSTALL_NAME_DIR)/$(SLIBNAME_WITH_MAJOR),-current_version,$(LIBVERSION),-compatibility_version,$(LIBMAJOR) -Wl,-read_only_relocs,suppress -Wl,-exported_symbols_list,$(SUBDIR)lib$(NAME).ver
ASMSTRIPFLAGS= -x
X86ASMFLAGS=-f macho32 -DPIC -DPREFIX
BUILDSUF=
PROGSSUF=
